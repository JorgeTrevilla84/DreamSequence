...
//camera_set_view_pos(cam, x-(new_w - view_w)*0.5, y-(new_h - view_h)*0.5);

camera_set_view_pos(cam, x-new_w *0.5, y-new_h*0.5 );

show_debug_message("***after xpos" + string(x) + " " + string(y) + "ypos");
show_debug_message("***view width and height" + string(view_width_half) + " " + string(view_height_half) + "ypos");
